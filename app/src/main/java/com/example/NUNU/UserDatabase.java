...
public class UserDatabase {
    ...
    private class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            // TABLE_NOTE
            println("creating table [" + TABLE_USER + "].");
            ...
            // create table
            String CREATE_SQL = "create table " + TABLE_USER + "("
                    + "  _id INTEGER  NOT NULL PRIMARY KEY AUTOINCREMENT, "
                    + "  username TEXT DEFAULT '', "
                    + "  leftSight REAL DEFAULT '', "
                    + "  rightSight REAL DEFAULT '', "
            ...
            // create index
            String CREATE_INDEX_SQL = "create index " + TABLE_USER + "_IDX ON " + TABLE_USER + "("
                    + "CREATE_DATE"
                    + ")";
            try {
