...
public class ChangeSight extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_change_sight, null);
        Context context=container.getContext();
        ImageButton gobackbtn = (ImageButton)view.findViewById(R.id.exit2);
        ...
        ImageButton donebtn = (ImageButton)view.findViewById(R.id.done2);
